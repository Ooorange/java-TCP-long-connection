package com.orange.blog.View.AlertVIew;
    ...
    class Holder {
        ...
        public void UpdateUI(Context context,String data,int position){
            ...
            if (mDestructive!= null && mDestructive.contains(data)){
                tvAlert.setTextColor(context.getResources().getColor(R.color.colorAccent));
            }
            else{
                tvAlert.setTextColor(context.getResources().getColor(R.color.light_green));
            }
        }
    }
}