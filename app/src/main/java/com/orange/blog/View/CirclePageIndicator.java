...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        mRadius = a.getDimension(R.styleable.CirclePageIndicator_radiusIndicator, defaultRadius);
     ...
     * MotionEventCompat.ACTION_POINTER_DOWN 当屏幕上已经有一个手指按住时,如果又有一个手指按下则会吊起
     * MotionEventCompat.ACTION_POINTER_UP:当屏幕上已经有多个手指按住时,松开一个会被吊起,即非最后一个点被放开时
     * @param ev
     * @return
     */
